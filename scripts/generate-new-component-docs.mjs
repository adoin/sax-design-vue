...
const components = {
  divider: {
    props: [
      ...
      ['icon', 'String', 'Iconify name', 'Show an Iconify icon instead of slot text.', null, '#icons'],
    ...
    sections: [
      ...
      { id: 'icons', title: 'Icons', demo: `<template>\n  <div class="center">\n    <s-divider icon="carbon:arrow-down" />\n    <s-divider color="primary" icon="carbon:star" />\n    <s-divider color="success" icon="carbon:checkmark" />\n    <s-divider color="danger" icon="carbon:trash-can" />\n    <s-divider color="warning" icon="carbon:warning" />\n    <s-divider color="dark" icon="carbon:time" />\n  </div>\n</template>\n\n${centerStyle}` },
...
const componentMetaZh = {
  divider: {
    ...
    leads: {
      ...
      icons: '通过 `icon` 在分割线内使用已配置的 Iconify 图标。',
