...
export const svgIconAnimationValues = ['auto', 'draw', 'pop', 'none'] as const
export type SvgIconAnimation = (typeof svgIconAnimationValues)[number]
...
export const useSvgIconAnimation = (
  customIconElement: CustomIconElement,
  getRequestedAnimation: () => SvgIconAnimation,
) => {
  const resolvedIconAnimation = shallowRef<SvgIconAnimation>(
  ...
  onMounted(() => {
    ...
    observer = new MutationObserver(scheduleIconPreparation)
  ...
  watch(getRequestedAnimation, scheduleIconPreparation)
