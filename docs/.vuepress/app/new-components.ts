...
export const newComponentNavItems: SidebarItem[] = [
  ...
  {
    text: 'Print page break',
    link: '/components/print-page-break',
    isNew: true,
  },
  ...
  { text: 'Checkbox button', link: '/components/checkbox-button', isNew: true },
  ...
  { text: 'Menu', link: '/components/menu', isNew: true },
  ...
  { text: 'Radio group', link: '/components/radio-group', isNew: true },
