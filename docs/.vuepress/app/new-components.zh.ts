...
export const newComponentNavItemsZh: SidebarItem[] = [
  ...
  { text: '表单分组', link: zh('/components/form-group'), isNew: true },
  { text: 'Progress', link: zh('/components/progress'), isNew: true },
  { text: '打印', link: zh('/components/print'), isNew: true },
  { text: '打印分页', link: zh('/components/print-page-break'), isNew: true },
  { text: 'Chip', link: zh('/components/chip'), isNew: true },
  { text: '日历', link: zh('/components/calendar'), isNew: true },
  { text: '日期面板', link: zh('/components/date-panel'), isNew: true },
  {
    text: '日期范围选择器',
    link: zh('/components/date-range-picker'),
    isNew: true,
  },
  { text: '轮播图', link: zh('/components/carousel'), isNew: true },
  { text: '按钮复选', link: zh('/components/checkbox-button'), isNew: true },
  ...
  { text: '菜单', link: zh('/components/menu'), isNew: true },
  { text: 'Images', link: zh('/components/images'), isNew: true },
  { text: '图标选择器', link: zh('/components/icon-picker'), isNew: true },
  ...
  { text: '单选组', link: zh('/components/radio-group'), isNew: true },
