...
<template>
  <div class="range-source-demo">
    <div class="range-source-demo__controls">
      <s-button size="small" @click="last">Last region</s-button>
      <s-button size="small" flat @click="all">Select entire view</s-button>
      <s-button size="small" flat @click="table?.clearCellRange()"
        >Clear range</s-button
      >
      <s-button size="small" flat @click="reset">Back to start</s-button>
    </div>
    <s-table
      ref="table"
