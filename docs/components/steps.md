...
Wait, process, loading, finish, success, error, and disabled states are built in. Loading uses the shared Sax logo loader unless the item supplies another icon.
