...
@[code{85-108}](../.vuepress/components/table/business.vue)

</template>

<template #script>

@[code{1-83}](../.vuepress/components/table/business.vue)

</template>

<template #style>

@[code{110-114}](../.vuepress/components/table/business.vue)
...
@[code{32-93}](../.vuepress/components/table/business-slots.vue)
...
@[code{95-99}](../.vuepress/components/table/business-slots.vue)
...
@[code{82-131}](../.vuepress/components/table/proxy-query.vue)

</template>

<template #script>

@[code{1-80}](../.vuepress/components/table/proxy-query.vue)
